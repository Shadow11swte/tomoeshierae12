...
module.exports = {
  ...
  const xen1 = new MessageEmbed().setDescription("Bu işlemi gerçekleştirebilmek için `KICK_MEMBERS` yetkisine sahip olmalıyım").setColor("RED").setFooter(configembedembedFooter).setAuthor("Tomoe").setTimestamp()
  ...
  const xen4 = new MessageEmbed().setDescription(`${message.author} Atmak istediğin kişi senden üst yada aynı pozisyonda.`).setColor("RANDOM").setFooter(configembedembedFooter).setAuthor("Tomoe").setTimestamp()
  const xen5 = new MessageEmbed().setDescription(`${message.author} sunucu sahibini atamazsın`).setColor("RANDOM").setFooter(configembedembedFooter).setAuthor("Tomoe").setTimestamp()
  ...
  .setColor("RED")
    ...
    .setColor(`RED`)
    .setFooter("Tomoe")
    .setImage('https://cdn.discordapp.com/attachments/1079744146610335755/1079746606561251399/16af1dd48089193639cd3990e90db1b7.png');
 ...
 .setStyle("DANGER")
  ...
  .setColor(`RED`)
  .setFooter("Tomoe")
  .setImage('https://i.pinimg.com/564x/93/2e/82/932e82109ea834f1e4c6aeeefa5293fe.jpg');
