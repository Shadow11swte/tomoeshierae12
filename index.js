...
const canvas = Canvas.createCanvas(700, 250);
  ...
  const background = await Canvas.loadImage('https://i.pinimg.com/originals/ad/d1/60/add160181e3980a036eb1dde764993dc.gif');
...
client.on("guildMemberRemove", async member => {
  ...
  const background = await Canvas.loadImage(
    "https://i.pinimg.com/564x/68/a1/7b/68a17bfa108d49ed2007475f694a0f57.jpg"
  );
...
client.on("guildMemberAdd", async member => {
  ...
  const background = await Canvas.loadImage(
    "https://i.pinimg.com/564x/f6/d4/f0/f6d4f0f1586c8b671e2f6424e6b34cb0.jpg"
  );
  ctx.drawImage(background, 0, 0, canvas.width, canvas.height);
